...
PATH_ROOT = "https://github.com/fengwang/super_resolution/releases/download"
PATH_MODEL_4X_JS = f"{PATH_ROOT}/0.3/js.json"
PATH_MODEL_4X_WEIGHTS = f"{PATH_ROOT}/0.3/weights.h5"
PATH_MODEL_8X_JS = f"{PATH_ROOT}/0.3.1/js.json"
PATH_MODEL_8X_WEIGHTS = f"{PATH_ROOT}/0.3.1/weights.h5"
...
def download_remote_model(model_name, model_url):
    user_model_path = os.path.join(
        os.path.expanduser("~"), ".deepoffice", "super_resolution", "model"
    )
